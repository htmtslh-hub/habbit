...
- **Phiên bản Cache / Scripts hiện tại**: `app.js?v=5.9.4`, `style.css?v=5.10.9`, `all_books_data.js?v=5.9.6`, `i18n.js?v=5.8.0` (trong `index.html`), `admin.js?v=5.8.3` (trong `admin.html`) & Service Worker `CACHE_VERSION = '5.10.10'` (trong `sw.js`) — *cập nhật số phiên bản này mỗi khi thay đổi để buộc client tải lại cache mới.*
