...
(function () {
    ...
    "desktop_app_badge": "💻 WINDOWS APP",
    "desktop_app_headline": "Tải ứng dụng cho Máy tính",
    "desktop_app_desc": "Khởi động cùng Windows, mượt mà & thông báo chuẩn xác không cần mở trình duyệt.",
    "btn_download_setup": "Tải bản Cài đặt (.exe)",
    "btn_download_guide": "Tùy chọn & Hướng dẫn",
    "desktop_quick_text": "Dùng máy tính? Tải ứng dụng Habit Mastery cho Windows",
    "modal_download_title": "Tải Ứng Dụng Habit Mastery Cho Máy Tính",
    "modal_download_subtitle": "Trải nghiệm rèn luyện kỷ luật độc lập, mượt mà và tập trung tối đa trên Windows.",
    "card_installer_title": "Bản Cài Đặt (Setup .exe)",
    "card_installer_desc": "Tự động tạo biểu tượng trên Desktop, Start Menu & tích hợp thông báo hệ thống Windows.",
    "card_installer_btn": "⬇ Tải HabitMastery-Setup.exe (86 MB)",
    "card_portable_title": "Bản Di Động (Portable .exe)",
    "card_portable_desc": "Không cần cài đặt, tải về bấm chạy ngay lập tức. Thích hợp lưu trữ USB mang đi mọi nơi.",
    "card_portable_btn": "⬇ Tải HabitMastery-Portable.exe (78 MB)",
    "guide_sec_title": "💡 Hướng dẫn mở lần đầu nếu Windows cảnh báo:",
    "guide_step1": "Nếu màn hình hiện <em>\"Windows protected your PC\"</em>: Bấm <strong>\"More info\" (Thông tin thêm)</strong> → Chọn <strong>\"Run anyway\" (Vẫn chạy)</strong>.",
    ...
    "desktop_app_badge": "💻 WINDOWS APP",
    "desktop_app_headline": "Download for PC (Windows)",
    "desktop_app_desc": "Auto-starts with Windows, smooth performance & accurate reminders without browser tabs.",
    "btn_download_setup": "Download Installer (.exe)",
    "btn_download_guide": "Options & Guide",
    "desktop_quick_text": "Using PC? Download Habit Mastery for Windows",
    "modal_download_title": "Download Habit Mastery for Windows",
    "modal_download_subtitle": "Experience distraction-free habit tracking right on your desktop.",
    "card_installer_title": "Official Installer (Setup .exe)",
    "card_installer_desc": "Creates Desktop & Start Menu shortcuts, with native Windows notifications.",
    "card_installer_btn": "⬇ Download HabitMastery-Setup.exe (86 MB)",
    "card_portable_title": "Portable Version (.exe)",
    "card_portable_desc": "No installation required. Download and run immediately, perfect for USB drives.",
    "card_portable_btn": "⬇ Download HabitMastery-Portable.exe (78 MB)",
    "guide_sec_title": "💡 3-Step Guide for First Launch on Windows",
    "guide_step1": "If Windows SmartScreen appears: Click <strong>\"More info\"</strong> → Select <strong>\"Run anyway\"</strong>.",
    ...
    "desktop_app_badge": "💻 WINDOWS 客户端",
    "desktop_app_headline": "下载 Habit Mastery 电脑版",
    "desktop_app_desc": "随开机自启、极致流畅、精准桌面提醒，免去繁琐浏览器标签。",
    "btn_download_setup": "下载安装包 (.exe)",
    "btn_download_guide": "选项与使用指南",
    "desktop_quick_text": "在电脑上使用？下载 Habit Mastery Windows 桌面版",
    "modal_download_title": "下载 Habit Mastery 电脑桌面版 (Windows)",
    "modal_download_subtitle": "在电脑端体验独立、流畅、无干扰的自律习惯养成之旅。",
    "card_installer_title": "标准安装包 (Setup .exe)",
    "card_installer_desc": "自动创建桌面与开始菜单快捷方式，原生支持 Windows 系统通知。",
    "card_installer_btn": "⬇ 下载 HabitMastery-Setup.exe (86 MB)",
    "card_portable_title": "便携免安装版 (Portable .exe)",
    "card_portable_desc": "无需安装，双击即可即时运行。适合随身 U 盘使用。",
    "card_portable_btn": "⬇ 下载 HabitMastery-Portable.exe (78 MB)",
    "guide_sec_title": "💡 首次在 Windows 上打开的 3 步指南",
    "guide_step1": "若出现 Windows SmartScreen 蓝色提示：点击 <strong>\"更多信息 (More info)\"</strong> → 点击 <strong>\"仍要运行 (Run anyway)\"</strong>。",
