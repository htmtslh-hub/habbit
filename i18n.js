...
(function () {
    ...
    "card_portable_btn": "⬇ Tải HabitMastery-Portable.zip (86 MB)",
    ...
    "doc_hub_title": "KHO TÀI LIỆU & SÁCH TINH HOA TÂM THỨC",
    "doc_hub_desc": "Mở khóa các tuyệt tác về nhân tính, mưu lược, thương chiến và tư duy đỉnh cao để đọc trực tiếp trên ứng dụng!",
    "doc_free": "Miễn phí",
    "doc_owned": "✓ Đã sở hữu",
    "doc_special": "Tài Liệu Đặc Biệt",
    "tip_locked_edit": "Thói quen bị khóa - Bấm để chỉnh sửa hoặc xóa",
    "tip_edit_delete": "Chỉnh sửa & Xóa thói quen",
    "sq_loading": "⏳ Đang tải dữ liệu Tổ Đội...",
    "sq_rankup": "Tổ đội đã lên bậc",
    "sq_rankup_reward": "! Bạn nhận thưởng",
    "sq_you": "Bạn",
    "sq_checked_in": "Đã check-in hôm nay",
    "sq_not_done": "Chưa hoàn thành",
    "sq_nudge_btn": "⚡ Thúc giục",
    "sq_nudged": "đã gửi lời thúc giục tới",
    "sq_no_nudge": "Chưa có hoạt động thúc giục nào hôm nay.",
    "sq_default_name": "Tổ Đội Kỷ Luật",
    "sq_default_goal": "Cùng nhau rèn luyện thói quen mỗi ngày!",
    "sq_word": "Tổ Đội",
    "sq_invite_btn": "Mời Bạn Bè",
    "sq_max_rank": "(Bậc cao nhất)",
    "sq_leave": "Rời đội 🚪",
    "sq_log_title": "⚡ Nhật ký Thúc Giục & Hoạt Động",
    "sq_join_title": "🛡️ Gia Nhập Tổ Đội Rèn Luyện",
    "sq_join_desc": "Nghiên cứu chỉ ra rằng khi có đồng đội cùng theo dõi và nhắc nhở, tỷ lệ duy trì kỷ luật thói quen tăng tới {n}! Hãy tạo hoặc tham gia một tổ đội ngay.",
    "sq_create_title": "Tạo Tổ Đội Mới (3-5 Người)",
    "sq_icon_label": "Biểu tượng:",
    "sq_icon_1": "⚔️ Kiếm Tiên Phong",
    "sq_icon_2": "🐺 Sói Đầu Đàn",
    "sq_icon_3": "🦁 Sư Tử Kỷ Luật",
    "sq_icon_4": "🔥 Ngọn Lửa Bền Bỉ",
    "sq_icon_5": "🏆 Nhà Vô Địch",
    "sq_icon_6": "⚡ Tia Chớp Thần Tốc",
    "sq_icon_7": "🛡️ Khiên Bất Hoại",
    "sq_create_btn": "Tạo Tổ Đội Ngay",
    "sq_join_code_t": "🔑 Gia Nhập Bằng Mã Mời",
    "sq_join_code_d": "Nhập mã mời 6 ký tự do đội trưởng hoặc bạn bè gửi cho bạn:",
    "sq_join_btn": "Gia Nhập Đội",
    "sq_duel_loading": "⏳ Đang tải Đấu Trường 1v1...",
    "sq_duel_draw": "KẾT QUẢ HÒA CÂN NÃO (7/7)!",
    "sq_duel_win": "BẠN ĐÃ CHIẾN THẮNG TRẬN ĐẤU!",
    "sq_duel_lose": "BẠN ĐÃ THUA TRẬN ĐẤU!",
    "sq_duel_close": "Đóng trận đấu & Nhận kết quả",
    "sq_duel_ended": "🏁 ĐÃ KẾT THÚC",
    "sq_duel_running": "🔥 ĐANG TRANH TÀI 7 NGÀY",
    "sq_duel_score": "Đạt:",
    "sq_duel_waiting": "⏳ ĐANG CHỜ ĐỐI THỦ NHẬN KÈO",
    "sq_duel_pot": "Hũ thưởng:",
    "sq_duel_open": "đang chờ một đấu thủ vào nhận kèo.",
    "sq_duel_title": "⚔️ Đấu Trường Thách Đấu 1v1 (7-Day Streak Duel)",
    "sq_duel_stake": "CHỌN MỨC CƯỢC:",
    "sq_duel_my_room": "Phòng của bạn",
    "sq_duel_none": "Hiện chưa có phòng thách đấu nào đang mở. Hãy là người đầu tiên tạo kèo!",
    "ib_start_chat": "Bắt đầu trò chuyện...",
    "ib_warrior": "Chiến Binh",
    "ib_novice": "Tập sự",
    "ib_teammate": "Đồng đội rèn luyện",
    "ib_no_msgs": "Chưa có tin nhắn nào",
    "ib_no_msgs_hint": "Gửi lời chào hoặc một lời nhắc kỷ luật để bắt đầu kết nối!",
    "bp_equipped": "★ Đang trang bị",
    "bp_unlocked": "Đã mở khóa",
    "bp_unequip": "Tháo ra",
    "bp_equip": "Trang bị",
    "toast_quote_copied": "Đã sao chép câu trích dẫn!",
    "habit_lock_pill": "🔒 Khóa (Free)",
    "shop_read_now": "📖 Đọc ngay",
    "shop_get_free": "Nhận miễn phí",
    "shop_unlock": "Mở khóa",
    "doc_finish_book": "✨ Hoàn Thành Sách (+{n} Coins)",
    "inv_loading": "Đang tải…",
    "inv_no_server": "Không kết nối được máy chủ. Vui lòng thử lại.",
    "btn_close": "Đóng",
    "err_generic_short": "Có lỗi xảy ra.",
    "inv_already_claimed": "✓ Bạn đã nhập mã mời của một người bạn.",
    "inv_have_code": "Có mã mời của bạn bè?",
    "inv_code_ph": "VD: K7M2QP",
    "inv_claim_btn": "Nhận",
    "inv_hint": "Cần điểm danh đủ {min} lượt mới nhận được (bạn đang có {cur}). Nhận ngay +{reward} Coins.",
    "inv_title": "🎁 Mời bạn bè",
    "inv_desc": "Bạn bè dùng mã của bạn: bạn nhận <b style=\"color:var(--accent)\">+{a}</b> Coins, họ nhận <b style=\"color:var(--accent)\">+{b}</b> Coins.",
    "inv_label_code": "Mã mời của bạn",
    "inv_tip_copy": "Bấm để chép",
    "inv_label_link": "Đường dẫn mời",
    "inv_stat_invited": "Đã mời",
    "inv_stat_coins": "Coins nhận được",
    "inv_copied": "✓ Đã chép",
    "inv_copy_failed": "Không chép được. Bạn hãy chọn và sao chép thủ công nhé.",
    "inv_code_len": "Mã mời gồm 6 ký tự.",
    "tip_frozen": "🧊 Đã đóng băng chuỗi",
    "tip_repaired": "⚡ Đã hồi sinh chuỗi",
    "tip_locked_dot": "🔒 Khóa",
    "alert_habit_locked": "🔒 Thói quen này đang bị tạm khóa vì tài khoản của bạn đang ở gói Miễn phí (tối đa {n} thói quen).\n\nToàn bộ dữ liệu của bạn vẫn được lưu giữ an toàn 100%. Hãy nâng cấp gói Pro hoặc Premium để mở khóa và tiếp tục check-in!",
    "inbox_loading_users": "⏳ Đang tải danh sách chiến binh...",
    "inbox_load_users_failed": "Không thể tải danh sách chiến binh.",
    "inbox_loading_msgs": "⏳ Đang tải tin nhắn...",
    "inbox_load_msgs_failed": "Không thể tải tin nhắn.",
    "inbox_sent": "Đã gửi",
    "inbox_send_failed": "Lỗi gửi tin nhắn: ",
    "squad_share_invite": "Chia sẻ link mời vào đội",
    "squad_copy_invite": "Bấm để sao chép link mời",
    "squad_name_ph": "Tên tổ đội (VD: Chiến Binh 5H Sáng)...",
    "squad_goal_ph": "Mục tiêu chung của đội...",
    "auth_opening_google": "Đang mở cửa sổ đăng nhập Google...",
    "auth_sending_desktop": "Đang chuyển thông tin đăng nhập về ứng dụng máy tính...",
    "auth_error_prefix": "Lỗi: ",
    "share_caption": "Rèn kỷ luật như tu luyện — habit-mastery.com",
    "upsell_expired_text": "Gói <strong>{plan}</strong> đã hết hạn. Hệ thống tạm khóa thói quen từ thứ 4 trở đi (không mất dữ liệu).",
    "upsell_expired_btn": "Gia hạn ngay",
    "upsell_trial_text": "Dùng thử Premium — Còn <strong>{days} ngày</strong>",
    "upsell_trial_btn": "Nâng cấp ngay",
    "upsell_free_text": "Bạn đang dùng gói <strong>Free</strong> (giới hạn {n} thói quen)",
    "upsell_free_btn": "👑 Nâng cấp Pro/Premium",
    "upsell_locked_feature": "Tính năng Pro/Premium",
    "upsell_addbtn_title": "Giới hạn {n} thói quen (Free). Nâng cấp Pro/Premium!",
    "upsell_habit_locked": "🔒 Tạm khóa (Gói Free)",
    "upsell_habit_click": "Thói quen tạm khóa do gói Free chỉ hỗ trợ {n} thói quen. Bấm để nâng cấp Pro/Premium!",
    "upsell_habit_title": "🔒 Thói quen đang bị khóa (Gói Free giới hạn {n} thói quen)",
    "plan_badge_premium": "👑 Premium VIP",
    "plan_badge_pro": "⚡ Gói Pro",
    "plan_badge_trial": "⏳ Dùng thử (Trial)",
    "plan_badge_free": "🌱 Gói Free",
    "plan_badge_expired": "⚠️ Hết hạn ({plan})",
    "plan_status_expired": "⚠️ Đã hết hạn",
    "plan_status_trial": "Dùng thử ({days} ngày)",
    "plan_status_free": "Miễn phí",
    "plan_exp_unlimited": "Không giới hạn thời gian",
    "plan_exp_remaining": "{date} (Còn {days} ngày)",
    "plan_unlimited": "Không giới hạn",
    "plan_already_vip": "👑 Đã là VIP",
    "plan_expired_notice": "Gói {plan} của bạn đã hết hạn. Hệ thống đang áp dụng gói Free (giới hạn {n} thói quen). Toàn bộ dữ liệu của các thói quen khác vẫn được lưu giữ an toàn, hãy gia hạn để tiếp tục sử dụng!",
    "plan_limit_confirm": "🌱 Tài khoản của bạn đang ở gói Free (giới hạn tối đa {n} thói quen).\n\nBạn có muốn XÓA bớt thói quen cũ để thêm thói quen mới không?\n\n- Bấm \"OK\": Để xem danh sách và xóa bớt thói quen cũ.\n- Bấm \"Hủy\": Để nâng cấp Pro hoặc Premium sử dụng không giới hạn.",
    "upg_title": "Nâng Cấp Gói VIP",
    "upg_sub": "Mở khóa toàn bộ sức mạnh Habit Mastery: Gói Pro (Tháng) &amp; Gói Premium (Năm)",
    "upg_step1": "Chọn gói",
    "upg_step2": "Thanh toán",
    "upg_step3": "Hoàn tất",
    "upg_free_title": "Free (Miễn phí)",
    "upg_free_habits": "{n} thói quen hoạt động",
    "upg_free_2": "Theo dõi &amp; check-in ngày",
    "upg_free_3": "Đồng bộ đám mây",
    "upg_free_4": "Biểu đồ phân tích",
    "upg_free_5": "Heatmap cả năm",
    "upg_free_6": "Nhật ký Daily Notes",
    "upg_paid_title": "Pro &amp; Premium",
    "upg_paid_1": "Không giới hạn thói quen",
    "upg_paid_2": "Biểu đồ phân tích chi tiết",
    "upg_paid_3": "Heatmap hoạt động cả năm",
    "upg_paid_4": "Ghi chú nhật ký Daily Notes",
    "upg_paid_5": "Không khóa thói quen",
    "upg_plan_pro": "⚡ Gói Pro (Tháng)",
    "upg_plan_pro_term": "Thời hạn: 30 ngày",
    "upg_plan_prem": "👑 Gói Premium (Năm)",
    "upg_plan_prem_term": "Thời hạn: 365 ngày",
    "upg_badge_save": "Tiết kiệm 65%",
    "upg_next": "Tiếp tục thanh toán →",
    "upg_success": "🎉 Thanh toán thành công!",
    "upg_success_sub": "Tài khoản của bạn đã được kích hoạt VIP",
    "upg_success_btn": "Bắt đầu sử dụng ngay →",
    "upg_expired": "Đã hết thời gian thanh toán",
    "upg_expired_sub": "Vui lòng tạo đơn thanh toán mới",
    "upg_retry": "Thử lại",
    ...
    "policy_pricing_link": "Bảng giá",
    "policy_terms_link": "Điều khoản dịch vụ",
    "policy_refund_link": "Chính sách hoàn tiền",
    ...
    "card_portable_btn": "⬇ Download HabitMastery-Portable.zip (86 MB)",
    ...
    "doc_hub_title": "MIND & MASTERY LIBRARY",
    "doc_hub_desc": "Unlock classics on human nature, strategy, business and high-level thinking — read them right inside the app!",
    "doc_free": "Free",
    "doc_owned": "✓ Owned",
    "doc_special": "Special document",
    "tip_locked_edit": "Habit locked — click to edit or delete",
    "tip_edit_delete": "Edit & delete habit",
    "sq_loading": "⏳ Loading squad data...",
    "sq_rankup": "Your squad ranked up",
    "sq_rankup_reward": "! You earned",
    "sq_you": "You",
    "sq_checked_in": "Checked in today",
    "sq_not_done": "Not done yet",
    "sq_nudge_btn": "⚡ Nudge",
    "sq_nudged": "nudged",
    "sq_no_nudge": "No nudges yet today.",
    "sq_default_name": "Discipline Squad",
    "sq_default_goal": "Building habits together, every day!",
    "sq_word": "Squad",
    "sq_invite_btn": "Invite friends",
    "sq_max_rank": "(Top rank)",
    "sq_leave": "Leave squad 🚪",
    "sq_log_title": "⚡ Nudge & activity log",
    "sq_join_title": "🛡️ Join a training squad",
    "sq_join_desc": "Research shows that having teammates who track and remind you raises habit adherence by {n}. Create or join a squad now.",
    "sq_create_title": "Create a new squad (3-5 people)",
    "sq_icon_label": "Icon:",
    "sq_icon_1": "⚔️ Vanguard Blade",
    "sq_icon_2": "🐺 Alpha Wolf",
    "sq_icon_3": "🦁 Disciplined Lion",
    "sq_icon_4": "🔥 Enduring Flame",
    "sq_icon_5": "🏆 Champion",
    "sq_icon_6": "⚡ Swift Lightning",
    "sq_icon_7": "🛡️ Unbreakable Shield",
    "sq_create_btn": "Create squad",
    "sq_join_code_t": "🔑 Join with an invite code",
    "sq_join_code_d": "Enter the 6-character invite code your squad leader or a friend sent you:",
    "sq_join_btn": "Join squad",
    "sq_duel_loading": "⏳ Loading the 1v1 arena...",
    "sq_duel_draw": "IT'S A DRAW (7/7)!",
    "sq_duel_win": "YOU WON THE DUEL!",
    "sq_duel_lose": "YOU LOST THE DUEL!",
    "sq_duel_close": "Close duel & collect result",
    "sq_duel_ended": "🏁 ENDED",
    "sq_duel_running": "🔥 7-DAY DUEL IN PROGRESS",
    "sq_duel_score": "Score:",
    "sq_duel_waiting": "⏳ WAITING FOR AN OPPONENT",
    "sq_duel_pot": "Prize pot:",
    "sq_duel_open": "is waiting for someone to accept.",
    "sq_duel_title": "⚔️ 1v1 Challenge Arena (7-day streak duel)",
    "sq_duel_stake": "CHOOSE YOUR STAKE:",
    "sq_duel_my_room": "Your room",
    "sq_duel_none": "No open challenge rooms right now. Be the first to create one!",
    "ib_start_chat": "Start a conversation...",
    "ib_warrior": "Warrior",
    "ib_novice": "Novice",
    "ib_teammate": "Training teammate",
    "ib_no_msgs": "No messages yet",
    "ib_no_msgs_hint": "Say hello or send a discipline reminder to get started!",
    "bp_equipped": "★ Equipped",
    "bp_unlocked": "Unlocked",
    "bp_unequip": "Unequip",
    "bp_equip": "Equip",
    "toast_quote_copied": "Quote copied!",
    "habit_lock_pill": "🔒 Locked (Free)",
    "shop_read_now": "📖 Read now",
    "shop_get_free": "Get for free",
    "shop_unlock": "Unlock",
    "doc_finish_book": "✨ Finish book (+{n} Coins)",
    "inv_loading": "Loading…",
    "inv_no_server": "Could not reach the server. Please try again.",
    "btn_close": "Close",
    "err_generic_short": "Something went wrong.",
    "inv_already_claimed": "✓ You have already used a friend's invite code.",
    "inv_have_code": "Have a friend's invite code?",
    "inv_code_ph": "e.g. K7M2QP",
    "inv_claim_btn": "Claim",
    "inv_hint": "You need {min} check-ins to claim this (you have {cur}). Get +{reward} Coins right away.",
    "inv_title": "🎁 Invite friends",
    "inv_desc": "When a friend uses your code: you get <b style=\"color:var(--accent)\">+{a}</b> Coins, they get <b style=\"color:var(--accent)\">+{b}</b> Coins.",
    "inv_label_code": "Your invite code",
    "inv_tip_copy": "Click to copy",
    "inv_label_link": "Invite link",
    "inv_stat_invited": "Invited",
    "inv_stat_coins": "Coins earned",
    "inv_copied": "✓ Copied",
    "inv_copy_failed": "Could not copy. Please select and copy it manually.",
    "inv_code_len": "An invite code is 6 characters.",
    "pomoSoundMixerTitle": "<svg class=\"rune-inline\" viewBox=\"0 0 48 48\"><use href=\"#i-mixer\"></use></svg> FOCUS SOUND MIXER:",
    "tip_frozen": "🧊 Streak frozen",
    "tip_repaired": "⚡ Streak restored",
    "tip_locked_dot": "🔒 Locked",
    "alert_habit_locked": "🔒 This habit is locked because your account is on the Free plan ({n} habits max).\n\nAll of your data is kept safe. Upgrade to Pro or Premium to unlock it and keep checking in!",
    "inbox_loading_users": "⏳ Loading members...",
    "inbox_load_users_failed": "Could not load the member list.",
    "inbox_loading_msgs": "⏳ Loading messages...",
    "inbox_load_msgs_failed": "Could not load messages.",
    "inbox_sent": "Sent",
    "inbox_send_failed": "Could not send message: ",
    "squad_share_invite": "Share squad invite link",
    "squad_copy_invite": "Click to copy the invite link",
    "squad_name_ph": "Squad name (e.g. 5AM Warriors)...",
    "squad_goal_ph": "Shared squad goal...",
    "auth_opening_google": "Opening the Google sign-in window...",
    "auth_sending_desktop": "Sending your sign-in back to the desktop app...",
    "auth_error_prefix": "Error: ",
    "share_caption": "Discipline, practised daily — habit-mastery.com",
    "upsell_expired_text": "Your <strong>{plan}</strong> plan has expired. Habits beyond the free limit are locked — no data is lost.",
    "upsell_expired_btn": "Renew now",
    "upsell_trial_text": "Premium trial — <strong>{days} days</strong> left",
    "upsell_trial_btn": "Upgrade now",
    "upsell_free_text": "You are on the <strong>Free</strong> plan ({n} habits max)",
    "upsell_free_btn": "👑 Upgrade to Pro/Premium",
    "upsell_locked_feature": "Pro/Premium feature",
    "upsell_addbtn_title": "Free plan is limited to {n} habits. Upgrade to Pro/Premium!",
    "upsell_habit_locked": "🔒 Locked (Free plan)",
    "upsell_habit_click": "This habit is locked because the Free plan allows {n} habits. Click to upgrade to Pro/Premium!",
    "upsell_habit_title": "🔒 Habit locked (Free plan allows {n} habits)",
    "plan_badge_premium": "👑 Premium VIP",
    "plan_badge_pro": "⚡ Pro plan",
    "plan_badge_trial": "⏳ Trial",
    "plan_badge_free": "🌱 Free plan",
    "plan_badge_expired": "⚠️ Expired ({plan})",
    "plan_status_expired": "⚠️ Expired",
    "plan_status_trial": "Trial ({days} days)",
    "plan_status_free": "Free",
    "plan_exp_unlimited": "No time limit",
    "plan_exp_remaining": "{date} ({days} days left)",
    "plan_unlimited": "Unlimited",
    "plan_already_vip": "👑 Already VIP",
    "plan_expired_notice": "Your {plan} plan has expired. The Free plan is being applied ({n} habits max). All your other habit data is kept safe — renew to continue using it.",
    "plan_limit_confirm": "🌱 Your account is on the Free plan ({n} habits max).\n\nWould you like to DELETE an older habit to make room for a new one?\n\n- Press \"OK\": see the list and delete an older habit.\n- Press \"Cancel\": upgrade to Pro or Premium for unlimited habits.",
    "upg_title": "Upgrade Your Plan",
    "upg_sub": "Unlock everything Habit Mastery has to offer — Pro (30 days) &amp; Premium (365 days)",
    "upg_step1": "Choose a plan",
    "upg_step2": "Payment",
    "upg_step3": "Done",
    "upg_free_title": "Free",
    "upg_free_habits": "{n} active habits",
    "upg_free_2": "Daily tracking &amp; check-ins",
    "upg_free_3": "Cloud sync",
    "upg_free_4": "Analytics charts",
    "upg_free_5": "Full-year heatmap",
    "upg_free_6": "Daily journal notes",
    "upg_paid_title": "Pro &amp; Premium",
    "upg_paid_1": "Unlimited habits",
    "upg_paid_2": "Detailed analytics charts",
    "upg_paid_3": "Full-year activity heatmap",
    "upg_paid_4": "Daily journal notes",
    "upg_paid_5": "No habit locking",
    "upg_plan_pro": "⚡ Pro",
    "upg_plan_pro_term": "30 days of access",
    "upg_plan_prem": "👑 Premium",
    "upg_plan_prem_term": "365 days of access",
    "upg_badge_save": "Save 65%",
    "upg_next": "Continue to payment →",
    "upg_success": "🎉 Payment successful!",
    "upg_success_sub": "Your account has been upgraded",
    "upg_success_btn": "Start using it now →",
    "upg_expired": "Payment window expired",
    "upg_expired_sub": "Please start a new payment",
    "upg_retry": "Try again",
    ...
    "policy_pricing_link": "Pricing",
    "policy_terms_link": "Terms of Service",
    "policy_refund_link": "Refund Policy",
    ...
    "card_portable_btn": "⬇ 下载 HabitMastery-Portable.zip (86 MB)",
    ...
    "doc_hub_title": "心智精粹书库",
    "doc_hub_desc": "解锁关于人性、谋略、商战与高阶思维的经典著作，直接在应用内阅读！",
    "doc_free": "免费",
    "doc_owned": "✓ 已拥有",
    "doc_special": "特别文档",
    "tip_locked_edit": "习惯已锁定 —— 点击可编辑或删除",
    "tip_edit_delete": "编辑与删除习惯",
    "sq_loading": "⏳ 正在加载小队数据...",
    "sq_rankup": "小队已晋级",
    "sq_rankup_reward": "！您获得奖励",
    "sq_you": "您",
    "sq_checked_in": "今日已打卡",
    "sq_not_done": "尚未完成",
    "sq_nudge_btn": "⚡ 催促",
    "sq_nudged": "催促了",
    "sq_no_nudge": "今天还没有催促记录。",
    "sq_default_name": "自律小队",
    "sq_default_goal": "每天一起培养习惯！",
    "sq_word": "小队",
    "sq_invite_btn": "邀请好友",
    "sq_max_rank": "（最高等级）",
    "sq_leave": "退出小队 🚪",
    "sq_log_title": "⚡ 催促与活动记录",
    "sq_join_title": "🛡️ 加入训练小队",
    "sq_join_desc": "研究表明，有队友互相监督和提醒时，习惯坚持率可提升 {n}。立即创建或加入一个小队吧。",
    "sq_create_title": "创建新小队（3-5 人）",
    "sq_icon_label": "图标：",
    "sq_icon_1": "⚔️ 先锋之剑",
    "sq_icon_2": "🐺 头狼",
    "sq_icon_3": "🦁 自律之狮",
    ...
    "sq_icon_6": "⚡ 神速闪电",
    "sq_icon_7": "🛡️ 不坏之盾",
    "sq_create_btn": "立即创建小队",
    "sq_join_code_t": "🔑 使用邀请码加入",
    "sq_join_code_d": "输入队长或好友发给您的 6 位邀请码：",
    "sq_join_btn": "加入小队",
    "sq_duel_loading": "⏳ 正在加载 1v1 竞技场...",
    "sq_duel_draw": "平局（7/7）！",
    "sq_duel_win": "您赢得了对决！",
    "sq_duel_lose": "您输掉了对决！",
    "sq_duel_close": "结束对决并领取结果",
    "sq_duel_ended": "🏁 已结束",
    "sq_duel_running": "🔥 7 天对决进行中",
    "sq_duel_score": "成绩：",
    "sq_duel_waiting": "⏳ 等待对手接受挑战",
    "sq_duel_pot": "奖池：",
    "sq_duel_open": "正在等待挑战者接受。",
    "sq_duel_title": "⚔️ 1v1 挑战竞技场（7 天连续对决）",
    "sq_duel_stake": "选择赌注：",
    "sq_duel_my_room": "您的房间",
    "sq_duel_none": "目前没有开放的挑战房间。来做第一个发起者吧！",
    "ib_start_chat": "开始对话...",
    "ib_warrior": "战士",
    "ib_novice": "见习",
    "ib_teammate": "训练队友",
    "ib_no_msgs": "还没有消息",
    "ib_no_msgs_hint": "打个招呼或发一句自律提醒，开始交流吧！",
    "bp_equipped": "★ 已装备",
    "bp_unlocked": "已解锁",
    "bp_unequip": "卸下",
    "bp_equip": "装备",
    "toast_quote_copied": "引言已复制！",
    "habit_lock_pill": "🔒 已锁定（免费版）",
    "shop_read_now": "📖 立即阅读",
    "shop_get_free": "免费获取",
    "shop_unlock": "解锁",
    "doc_finish_book": "✨ 完成阅读（+{n} 金币）",
    "inv_loading": "加载中…",
    "inv_no_server": "无法连接服务器，请重试。",
    "btn_close": "关闭",
    "err_generic_short": "出错了。",
    "inv_already_claimed": "✓ 您已使用过好友的邀请码。",
    "inv_have_code": "有好友的邀请码？",
    "inv_code_ph": "例如：K7M2QP",
    "inv_claim_btn": "领取",
    "inv_hint": "需要打卡 {min} 次才能领取（您目前 {cur} 次）。立即获得 +{reward} 金币。",
    "inv_title": "🎁 邀请好友",
    "inv_desc": "好友使用您的邀请码：您获得 <b style=\"color:var(--accent)\">+{a}</b> 金币，对方获得 <b style=\"color:var(--accent)\">+{b}</b> 金币。",
    "inv_label_code": "您的邀请码",
    "inv_tip_copy": "点击复制",
    "inv_label_link": "邀请链接",
    "inv_stat_invited": "已邀请",
    "inv_stat_coins": "已获得金币",
    "inv_copied": "✓ 已复制",
    "inv_copy_failed": "复制失败，请手动选择并复制。",
    "inv_code_len": "邀请码为 6 位字符。",
    "pomoSoundMixerTitle": "<svg class=\"rune-inline\" viewBox=\"0 0 48 48\"><use href=\"#i-mixer\"></use></svg> 专注音效混音器：",
    "tip_frozen": "🧊 连续记录已冻结",
    "tip_repaired": "⚡ 连续记录已恢复",
    "tip_locked_dot": "🔒 已锁定",
    "alert_habit_locked": "🔒 此习惯已锁定，因为您的账户为免费版（最多 {n} 个习惯）。\n\n您的数据全部安全保留。升级到 Pro 或 Premium 即可解锁并继续打卡！",
    "inbox_loading_users": "⏳ 正在加载成员...",
    "inbox_load_users_failed": "无法加载成员列表。",
    "inbox_loading_msgs": "⏳ 正在加载消息...",
    "inbox_load_msgs_failed": "无法加载消息。",
    "inbox_sent": "已发送",
    "inbox_send_failed": "消息发送失败：",
    "squad_share_invite": "分享小队邀请链接",
    "squad_copy_invite": "点击复制邀请链接",
    "squad_name_ph": "小队名称（例如：清晨五点战士）...",
    "squad_goal_ph": "小队共同目标...",
    "auth_opening_google": "正在打开 Google 登录窗口...",
    "auth_sending_desktop": "正在将登录信息传回桌面应用...",
    "auth_error_prefix": "错误：",
    "share_caption": "像修行一样锤炼自律 — habit-mastery.com",
    "upsell_expired_text": "您的 <strong>{plan}</strong> 方案已到期。超出免费额度的习惯已锁定，数据不会丢失。",
    "upsell_expired_btn": "立即续费",
    "upsell_trial_text": "Premium 试用 —— 还剩 <strong>{days} 天</strong>",
    "upsell_trial_btn": "立即升级",
    "upsell_free_text": "您正在使用<strong>免费版</strong>（最多 {n} 个习惯）",
    "upsell_free_btn": "👑 升级到 Pro/Premium",
    "upsell_locked_feature": "Pro/Premium 功能",
    "upsell_addbtn_title": "免费版限 {n} 个习惯。升级到 Pro/Premium！",
    "upsell_habit_locked": "🔒 已锁定（免费版）",
    "upsell_habit_click": "免费版仅支持 {n} 个习惯，此习惯已锁定。点击升级到 Pro/Premium！",
    "upsell_habit_title": "🔒 习惯已锁定（免费版限 {n} 个习惯）",
    "plan_badge_premium": "👑 Premium VIP",
    "plan_badge_pro": "⚡ Pro 方案",
    "plan_badge_trial": "⏳ 试用",
    "plan_badge_free": "🌱 免费版",
    "plan_badge_expired": "⚠️ 已到期（{plan}）",
    "plan_status_expired": "⚠️ 已到期",
    "plan_status_trial": "试用（{days} 天）",
    "plan_status_free": "免费",
    "plan_exp_unlimited": "无时间限制",
    "plan_exp_remaining": "{date}（还剩 {days} 天）",
    "plan_unlimited": "不限",
    "plan_already_vip": "👑 已是 VIP",
    "plan_expired_notice": "您的 {plan} 方案已到期，现按免费版执行（最多 {n} 个习惯）。其余习惯的数据均安全保留，续费即可继续使用！",
    "plan_limit_confirm": "🌱 您的账户为免费版（最多 {n} 个习惯）。\n\n是否删除旧习惯以腾出位置？\n\n- 点击\"确定\"：查看列表并删除旧习惯。\n- 点击\"取消\"：升级到 Pro 或 Premium，习惯不限。",
    "upg_title": "升级方案",
    "upg_sub": "解锁 Habit Mastery 全部功能 —— Pro（30 天）与 Premium（365 天）",
    "upg_step1": "选择方案",
    "upg_step2": "付款",
    "upg_step3": "完成",
    "upg_free_title": "免费版",
    "upg_free_habits": "{n} 个活跃习惯",
    "upg_free_2": "每日追踪与打卡",
    "upg_free_3": "云端同步",
    "upg_free_4": "分析图表",
    "upg_free_5": "全年热力图",
    "upg_free_6": "每日笔记日志",
    "upg_paid_title": "Pro 与 Premium",
    "upg_paid_1": "习惯数量不限",
    "upg_paid_2": "详细分析图表",
    "upg_paid_3": "全年活跃度热力图",
    "upg_paid_4": "每日笔记日志",
    "upg_paid_5": "不锁定习惯",
    "upg_plan_pro": "⚡ Pro",
    "upg_plan_pro_term": "30 天使用期",
    "upg_plan_prem": "👑 Premium",
    "upg_plan_prem_term": "365 天使用期",
    "upg_badge_save": "省 65%",
    "upg_next": "继续付款 →",
    "upg_success": "🎉 付款成功！",
    "upg_success_sub": "您的账户已升级",
    "upg_success_btn": "立即开始使用 →",
    "upg_expired": "付款时间已过",
    "upg_expired_sub": "请重新发起付款",
    "upg_retry": "重试",
    "dqwRefresh": "换一句格言",
    "dqwCopy": "复制这句话",
    "dqwShare": "分享到快拍",
    ...
    "policy_pricing_link": "价格",
    "policy_terms_link": "服务条款",
    "policy_refund_link": "退款政策",
